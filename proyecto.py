#Sistema  experot 
#Jesus Alejandro Contreras Ruiz 21310157
...
class SistemaExpertoApp:
    ...
    def encontrar_procesador(self):
        ...
        def verificar_resultado():
            ...
            if len(resultados) == 1:
                procesador = resultados[0]
                resultado_texto = (f"Modelo: {procesador[2]} - {procesador[1]} ({procesador[3]}), "
                                   f"{procesador[5]} núcleos, {procesador[6]} hilos, precio: {procesador[7]}, "
                                   f"uso: {procesador[4]}")
